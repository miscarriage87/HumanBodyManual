// Direct fix for tests
const fs = require('fs');
const path = require('path');

// Create a direct test file that doesn't rely on mocking
console.log('Creating direct test file...');
...
const directTestPath = path.join(__dirname, '__tests__', 'direct-tests.test.ts');
fs.writeFileSync(directTestPath, directTestContent);
console.log('Created direct-tests.test.ts');

console.log('Run tests with: npm test -- direct-tests.test.ts');